...
import '../../modules/user/service/i_use_service.dart' as _i9;
import '../../modules/user/service/use_service.dart' as _i10;
import '../database/database_connection.dart' as _i4;
import '../database/i_database_connection.dart' as _i3;
import '../logger/i_loger.dart' as _i8;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i9.IUseService>(
      () => _i10.UseService(userRepository: get<_i6.IUserRepository>()));
  gh.factory<_i11.AuthController>(() => _i11.AuthController(
      userService: get<_i9.IUseService>(), log: get<_i8.ILogger>()));
  return get;
}
